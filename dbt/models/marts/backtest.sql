...
final as (
    ...
    left join
        ...
        on
            i.symbol = optimal_buy_window.symbol
    ...
    left join
        ...
        on
            i.ts = buys.buy_ts
            and i.symbol = buys.symbol
            and s.strategy_id = buys.strategy_id
    left join
        backtest_results as sells
        on
            i.ts = sells.sell_ts
            and i.symbol = sells.symbol
            and s.strategy_id = sells.strategy_id
)
